(letfn [(github-assignment [assignment]
          (format "https://github.com/codezoners/cohort-3/tree/master/HTML/02_forms_controls_inputs/assignments/%s/HANDOUT" assignment))]
  (render :theme :sky
          ...
          :slides [[:section
                   ...
                   [:section
                    [:section
                     ...
                     [:p "See the "
                      [:a {:href (github-assignment "basic-params")} "README"] "."]]
                   ...
                   [:section
                    [:section
                     ...
                     [:p "(" [:a {:href (github-assignment "posted-params")} "README"] ".)"]]
                   ...
                   [:section
                    [:section
                     ...
                     [:p "(" [:a {:href (github-assignment "flags")} "README"] ".)"]]
                   ...
                   [:section
                    [:section
                     [:h3 "Exercise 4"]
                     [:h4 "Smarter Flags"]
                     [:p "(" [:a {:href (github-assignment "flags-2")} "README"] ".)"]]
                   ...
                   [:section
                    [:section
                     [:h3 "Exercise 5"]
                     [:h4 "A Home Page"]
                     [:p "(" [:a {:href (github-assignment "iframes")} "README"] ".)"]
                     ]
