(letfn [(github-assignment [assignment]
          (format "https://github.com/codezoners/cohort-3/tree/master/HTML/03_templating_with_Jinja2/assignments/%s" assignment))]
  (render :theme :sky
          ...
          :slides [[:section
                   ...
                   [:section
                    [:section
                     ...
                     [:p "See the " [:a {:href (github-assignment "basics")} "README"] "."]
                   ...
                   [:section
                    ...
                    [:section
                     ...
                     [:p "See the " [:a {:href (github-assignment "login")} "README"] "."]
                   ...
                   [:section
                    ...
                    [:section
                     ...
                     [:p "See the " [:a {:href (github-assignment "superhero")} "README"] "."]]
                   ...
                   [:section
                    ...
                    [:section
                     ...
                     [:ul
                      [:li "Rather than HTML tables, attempt this with " (tt "<DIV>") " and "
                       (tt "<SPAN>") " elements"]
                   ...
                   [:section
                    ...
                    [:section
                     [:ul
                      ...
                      [:li "Implement the table with " (tt "<DIV>") " and "
                       (tt "<SPAN>") " rather than an HTML table"]
